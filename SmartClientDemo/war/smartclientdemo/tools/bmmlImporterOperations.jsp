...
if (baseConfig.getBoolean("BMMLImporter.useIDACall", false)) {
    response.sendError(HttpServletResponse.SC_FORBIDDEN, "Because BMMLImporter.useIDACall in the server config is set, bmmlImporterOperations.jsp is disabled.");
    return;
}
