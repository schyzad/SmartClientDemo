...
/*
  ...
  Version v9.0p_2014-04-28/EVAL Development Only (2014-04-28)
...
if(this.getSubscribedChannels().length==0)return;var _1=isc.HiddenFrame.create({useHtmlfile:isc.Browser.isIE});this.$zs=_1.getID();this.$1125();var _2={type:"connect",connectionID:this.$zs,subscribedChannels:isc.Comm.serialize(this._channels)};var _3=isc.URIBuilder.create(isc.Page.getURL(this.messagingURL));_3.setQueryParam("ts",isc.timestamp());if(isc.Messaging.$1129){isc.Messaging.$1129=false;_3.setQueryParam("disconnectUponConnect","true")}
if(this.useEventSource){_1.$ic();for(var _4 in _2){if(!_2.hasOwnProperty(_4))continue;_3.setQueryParam(_4,String(_2[_4]))}
_3.setQueryParam("eventStream","true");var _5=function createEventListener(_12){return function(_13){var _6=location.origin;if(_6==null){_6=location.protocol+"//"+location.host}
if(_13.origin==undefined||_13.origin!=_6){isc.Messaging.logWarn("'"+_12+"' event received with wrong origin: "+_13.origin+" (should be "+_6+")");return}
_1.$ie.document.write("<SCRIPT>"+_13.data+"</SCRIPT>")}};var _7=this.$112x=new EventSource(_3.uri);_7.onerror=isc.Messaging.$1123;_7.addEventListener("connectCallback",this.$112y=_5("connectCallback"),false);_7.addEventListener("establishAck",this.$112z=_5("establishAck"),false);_7.addEventListener("keepalive",this.$1120=_5("keepalive"),false);_7.addEventListener("message",this.$1121=_5("message"),false);_7.addEventListener("serverConnTerminate",this.$1122=_5("serverConnTerminate"),false)}else if(this.useAJAX){_1.$ic();var _8=0;var _9=this.$1126=function(){if(_9!=isc.Messaging.$1126)return;var _10=isc.Messaging.$1127;if(!_10)return;if(_10.readyState==3||_10.readyState==4||(isc.Browser.isOpera&&_10.readyState==2))
{var _11=_10.responseText.substring(_8);_8=_10.responseText.length;_1.$ie.document.write(_11)}};this.$1127=isc.Comm.sendXmlHttpRequest({URL:_3.uri,fields:_2,transaction:{changed:function(){},requestData:_2},onreadystatechange:_9})}else{isc.Comm.sendHiddenFrame({URL:_3.uri,fields:_2,transaction:{changed:function(){},requestData:_2},frame:_1})}
